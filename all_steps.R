  ...
  dataset <- switch(rfmo,
                    ...
                    "ICCAT" = {
                      ...
                      if(options$include_ICCAT){
                        ...
                        saveRDS(iccat_data_before_treatment, "..//../iccat_data_before_treatment.rds")
                      ...
                      iccat_data
                      saveRDS(iccat_data, "..//../iccat_data_after_treatment.rds")
                    },
                    #IATTC
                    #--------------------------------------------------------------------------------------
                    "IATTC" = {
                      ...
                      if(options$include_IATTC){
                        ...
                        saveRDS(iattc_data, "..//../iattc_data_before_treatment.rds")
                      ...
                      iattc_data
                      saveRDS(iattc_data, "..//../iattc_data_after_treatment.rds")
...
# write.csv(dataset$codelists, output_name_codelists, row.names = FALSE)
   ...
   for (i in seq(2:8)){
    saveRDS(as.name(paste0("georef_dataset_level0_step",i)), file = paste0("../../georef_dataset_level0_step", 
        i, paste0(entity$identifiers[["id"]],"data.rds")))
   }
